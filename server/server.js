...
const committeeFile = require("./lib/mongo/routes/committee-file");
const socialEvent = require("./lib/mongo/routes/social-event");
const memberResource = require("./lib/mongo/routes/member-resource");
