...
export const aws = {listObjects, putObject, putObjectDirect, getObject, listBuckets, urlToFile, getObjectInChunks, get, getObjectAsBase64, sendObject};
...
async function getObjectInChunks(req, res) {
