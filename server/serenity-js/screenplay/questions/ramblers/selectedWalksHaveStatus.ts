...
export class SelectedWalksWithStatusMatching implements Question<PromiseLike<boolean>> {
...
export class SelectedWalksWithStatusNotMatching implements Question<PromiseLike<boolean>> {
